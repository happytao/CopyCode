...
public class OrderListBean {
    ...
    public static class ResultDTO {
        ...
        private String freightChargeVal;
        ...
        private String totalConsumeCash;
        ...
        public String getFreightChargeVal() {
            return freightChargeVal;
        }

        public void setFreightChargeVal(String freightChargeVal) {
        ...
        public String getTotalConsumeCash() {
            return totalConsumeCash;
        }

        public void setTotalConsumeCash(String totalConsumeCash) {
        ...
        public static class SystemFreightChargeDTO {
            ...
            private String freightChargeValCash;
            private int freightChargeValScore;

            public String getFreightChargeValCash() {
                return freightChargeValCash;
            }

            public void setFreightChargeValCash(String freightChargeValCash) {
        ...
        public static class ChildOrderRespListDTO {
            ...
            private String refGoodsCashPrice;
            ...
            public String getRefGoodsCashPrice() {
                return refGoodsCashPrice;
            }

            public void setRefGoodsCashPrice(String refGoodsCashPrice) {
