...
@Route(path = RoutePathConstant.SUBSCRIBE_ORDER_COMPLETE)
class OrderSubscribeCompleteActivity : BaseActivity() {
    @JvmField
    @Autowired(name = RoutePathConstant.ORDER_ID)
    var id:Long = 0
    override fun initLayout(): Int {
        return R.layout.activity_order_subscribe_complete
    }
